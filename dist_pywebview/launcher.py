...
_SERVER_FLAG = "--_chord2tab_server"
...
def run_launcher() -> None:
    ...
    print(f"[Chord2Tab] Streamlit サーバー起動中 (port={port})…")
...
<body>
  ...
  <div class="note">初回起動時は BTC モデルの読み込みに時間がかかる場合があります</div>
    ...
    print("[Chord2Tab] ウィンドウが閉じられました。サーバーを終了します…")
    if sys.platform == "win32":
